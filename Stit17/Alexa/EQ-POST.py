...
def loop():
    ...
    while True:
        ...
        paramjson=get_jsonparsed_data(configBaseURL+str(indexACTIVENODE))
        ACTIVENODE=(paramjson["Value"]) #  # of secs to measure

        if ACTIVENODE == MYNODE:
            ...
            # Question MARK  screen for x secs ...
            xsecs=1.5
            questionm(sense)
            time.sleep(xsecs)
            # BLANK screen for 1 secs ...
